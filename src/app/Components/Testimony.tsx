...
const testimonials = [
  {
    ...
    image: "/images/rajesh.png", // Updated image path
  },
  {
    id: 2,
    name: "Priya Sharma",
    role: "IT Specialist",
    testimonial:
      "When we needed additional storage for our growing data center, Digital Link’s hard disks were the perfect choice. The reliability and speed of the drives have made our backup processes much more efficient. We’ve had zero issues, and the capacity options ensure we have room for growth in the future. Great value for the price!",
    social: { facebook: "#", instagram: "#" },
    image: "/images/priya.png", // Updated image path
  },
  {
    id: 3,
    name: "Amit Patel",
    ...
    image: "/images/amit.png", // Updated image path
  },
];
