          ...
          <AnimatePresence mode="wait">
            {filteredSolutions.length === 1 ? (
              <motion.div
                ...
                className="relative w-full h-[220px] md:h-[600px] rounded-xl overflow-hidden mb-6 flex items-center shadow-lg border border-gray-200"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
              ...
              >
                ...
                <div className="relative z-10 px-2 md:px-10 py-3 md:py-8 text-white w-full flex flex-col justify-center">
                  <div className="flex flex-col md:flex-row md:items-center mb-2 md:mb-4">
                    <span className="px-2 py-0.5 bg-blue-600 text-white text-xs font-semibold rounded-full mb-1 md:mb-0 md:mr-4 w-fit">
                      {
                        categories.find(
                  ...
                  <p className="text-xs md:text-lg mb-2 md:mb-6 leading-relaxed">
                  ...
                  <div className="flex flex-wrap gap-1 md:gap-3 mb-2 md:mb-8">
                    {filteredSolutions[0].features.map((feature, idx) => (
                      <motion.span
                        key={idx}
                        className="inline-flex items-center px-1.5 md:px-4 py-0.5 md:py-2 bg-white/20 backdrop-blur-sm rounded-full text-white text-[10px] md:text-sm font-medium border border-white/10"
                        initial={{ opacity: 0, x: -10 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ delay: 0.1 * idx }}
                      >
                        <CheckCircle className="w-2.5 h-2.5 md:w-4 md:h-4 text-green-600 mr-1 md:mr-2" />
                  ...
                  >
                    ...
                    <ArrowRight className="relative z-10 w-3 h-3 md:w-5 md:h-5 ml-1 md:ml-3 transition-all duration-300 ease-out group-hover:translate-x-1 group-hover:scale-110" />
                  </motion.button>
                </div>
              </motion.div>
            ) : (
              ...
              >
                {filteredSolutions.map((solution) => (
                  <motion.div
                    key={solution.id}
                    className="group bg-white rounded-lg md:rounded-xl shadow-lg hover:shadow-2xl transition-all duration-700 overflow-hidden border border-gray-200 hover:border-red-200"
                    variants={staggerItem}
                    whileHover={{ y: -5 }}
                  >
                    <div className="relative overflow-hidden h-32 md:h-64">
                      ...
                      <div className="absolute top-2 md:top-4 right-2 md:right-4">
                        <span className="px-1.5 md:px-3 py-0.5 bg-red-600 text-white text-[10px] md:text-xs font-semibold rounded-full transition-all duration-500 group-hover:bg-orange-500">
                          {
                            categories.find(
                    ...
                    <div className="p-2 md:p-6">
                      <h3 className="text-sm md:text-xl font-bold text-gray-900 mb-1 md:mb-3 group-hover:text-red-600 transition-colors duration-500">
                        {solution.title}
                      </h3>
                      <p className="text-gray-600 mb-2 md:mb-4 leading-relaxed text-xs md:text-base">
                        {solution.description}
                      </p>

                      <div className="space-y-1 md:space-y-2 mb-2 md:mb-6">
                        {solution.features.map((feature, index) => (
                          <div
                            key={index}
                            className="flex items-center text-[10px] md:text-sm text-gray-600"
                          >
                            <CheckCircle className="w-2.5 h-2.5 md:w-4 md:h-4 text-green-500 mr-1 flex-shrink-0" />
                      ...
                      <motion.button
                        ...
                        className="group w-full inline-flex items-center justify-center px-2 md:px-6 py-1.5 md:py-3 bg-transparent text-gray-700 font-semibold rounded-lg relative overflow-hidden transition-all duration-300 text-xs md:text-base"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        <span className="relative z-10 flex items-center text-white">
                          Learn More
                          <ArrowRight className="w-2.5 h-2.5 md:w-4 md:h-4 ml-1 md:ml-2 transform transition-transform duration-300 group-hover:translate-x-1" />
                        </span>
                        <span
